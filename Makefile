...
tecnicofs: fs/state.o fs/operations.o main.o fh/fileHandling.o thr/threads.o lst/list.o cq/circularqueue.o er/error.o
	$(LD) $(CFLAGS) $(LDFLAGS) -o tecnicofs fs/state.o fs/operations.o fh/fileHandling.o thr/threads.o lst/list.o cq/circularqueue.o er/error.o main.o
...
thr/threads.o: thr/threads.h thr/threads.c lst/list.h fs/state.h cq/circularqueue.h er/error.h
...
cq/circularqueue.o: cq/circularqueue.h cq/circularqueue.c er/error.h
	$(CC) $(CFLAGS) -o cq/circularqueue.o -c cq/circularqueue.c

main.o: main.c fs/operations.h fs/state.h fh/fileHandling.h thr/threads.h lst/list.h cq/circularqueue.h er/error.h tecnicofs-api-constants.h 
